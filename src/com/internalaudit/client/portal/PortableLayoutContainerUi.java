...
public class PortableLayoutContainerUi implements IsWidget {
  ...
  public Widget asWidget() {
     ...
     // portlet2.setHeadingHtml("Portal Layout — Panel 2");
      portlet2.add(createGridNew());
     // portlet2.add(getBogusText());
      configPanel(portlet2);

      Portlet portlet3 = new Portlet();
    //  portlet3.setHeadingHtml("Portal Layout — Panel 3");
     portlet3.add(createGridPlanning());
     // portlet3.add(getBogusText());
      configPanel(portlet3);

      Portlet portlet4 = new Portlet();
     // portlet4.setHeadingHtml("Portal Layout — Panel 4");
      portlet4.add(createGridReporting());
  ...
  public Widget createGridNew() {
	    final NumberFormat number = NumberFormat.getFormat("0.00");
	    
	    ColumnConfig<Stock, String> fieldworkCol = new ColumnConfig<Stock, String>(properties.name(), 150, "FieldWork");
	    ColumnConfig<Stock, Date> lastTransCol = new ColumnConfig<Stock, Date>(properties.lastTrans(), 100, "Exception");
	   // ColumnConfig<Stock, String> ExceptionlCol = new ColumnConfig<Stock, String>(properties.exceptionsLabel(), 105, "Exceptions");
	    ColumnConfig<Stock, String> WorkStepsComptCol = new ColumnConfig<Stock, String>(properties.symbol(), 150, "WorkSteps Completed");
//	    ColumnConfig<Stock, Double> changeCol = new ColumnConfig<Stock, Double>(properties.change(), 75, "Change");
...
//	    columns.add(lastTransCol);
  ...
  public Widget createGridPlanning() {
	    ...
	    ColumnConfig<Stock, String> fieldworkCol = new ColumnConfig<Stock, String>(properties.name(), 250, "Planning");
	   // ColumnConfig<Stock, String> ExceptionlCol = new ColumnConfig<Stock, String>(properties.exceptionsLabel(), 105, "Exceptions");
	  //  ColumnConfig<Stock, Double> WorkStepsComptCol = new ColumnConfig<Stock, Double>(properties.last(), 150, "WorkSteps Completed");
//	    ColumnConfig<Stock, Double> changeCol = new ColumnConfig<Stock, Double>(properties.change(), 75, "Change");
	    ColumnConfig<Stock, Date> lastTransCol = new ColumnConfig<Stock, Date>(properties.lastTrans(), 100, "WorkSteps Completed");
...
//	    columns.add(lastTransCol);
  ...
  public Widget createGridReporting() {
	    ...
	    ColumnConfig<Stock, String> ReportingCol = new ColumnConfig<Stock, String>(properties.name(), 150, "Reporting");
//	    ColumnConfig<Stock, String> ExceptionlCol = new ColumnConfig<Stock, String>(properties.exceptionsLabel(), 105, "Exceptions");
//	    ColumnConfig<Stock, Double> WorkStepsComptCol = new ColumnConfig<Stock, Double>(properties.last(), 150, "WorkSteps Completed");
//	    ColumnConfig<Stock, Double> changeCol = new ColumnConfig<Stock, Double>(properties.change(), 75, "Change");
//	    ColumnConfig<Stock, Date> lastTransCol = new ColumnConfig<Stock, Date>(properties.lastTrans(), 100, "Last Updated");
...
//	    columns.add(lastTransCol);
  ...
  private HTML getBogusText() {
    HTML html = new HTML("TestData.DUMMY_TEXT_SHOR");
  ...
  public static List<Stock> getFieldWork() {
	  ...
	  //  stocks.add(new Stock("Apple Inc..", "AAPL", "aa"));
	    ...
	    stocks.add(new Stock("issues purchase order in system , Inc.", randomDate(),  "completed"));
