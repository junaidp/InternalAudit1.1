...
public class RiskAssesmentView extends Composite {
	...
	private static RiskAssesmentViewUiBinder uiBinder = GWT.create(RiskAssesmentViewUiBinder.class);

	interface RiskAssesmentViewUiBinder extends UiBinder<Widget, RiskAssesmentView> {
	}
