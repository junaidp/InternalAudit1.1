...
public class EmployeeDashBoardView extends Composite {
	...
	private static EmployeeDashBoardViewUiBinder uiBinder = GWT.create(EmployeeDashBoardViewUiBinder.class);

	interface EmployeeDashBoardViewUiBinder extends UiBinder<Widget, EmployeeDashBoardView> {
	}
	...
	private void setUserTable() {
		...
		// @Override
		// public String getValue(DashBoardDTO object) {
		// if(object.getApprovedBy().getEmployeeName().equalsIgnoreCase("no
		// user")){
		// return "";
		// }else{
	...
	// ListDataProvider<DashBoardDTO> dataProvider = new
	// ListDataProvider<DashBoardDTO>();
	...
	// list.add(group);
	// }
	// final ListHandler<DashBoardDTO> columnSortHandler = new
	// ListHandler<DashBoardDTO>(list);
	//
	// columnSortHandler.setComparator(objectiveName,new
	...
	//
	// return (o2 != null) ?
	// o1.getStrategicObjective().compareTo(o2.getStrategicObjective()) : 1;
	// }
	// return -1;
	// }
	// });
	...
	//
	// return (o2 != null) ?
	// o1.getAssignedTo().getEmployeeName().compareTo(o2.getAssignedTo().getEmployeeName())
	// : 1;
	// }
	// return -1;
	// }
	...
	//
	// return (o2 != null) ?
	// o1.getApprovedBy().getEmployeeName().compareTo(o2.getApprovedBy().getEmployeeName())
	// : 1;
	// }
	// return -1;
	// }
	...
	//
	// //
	// columnSortHandler.setComparator(statusColumn,new
	// Comparator<DashBoardDTO>() {
	//
	// public int compare(DashBoardDTO o1,DashBoardDTO o2) {
	// if (o1 == o2) {
