...
public class AuditNotificationViewData {
	...
	public void setData(AuditNotificationView auditNotificationView, InternalAuditServiceAsync rpcService,
				...
				new AsyncCallback<String>() {
					...
					public void onFailure(Throwable caught) {
						...
						if (caught instanceof TimeOutException) {
							...
							Window.alert("FAIL: saveAuditNotification, Please check all the fields");// After
																										// FAIL
																										// ...
																										// write
																										// RPC
