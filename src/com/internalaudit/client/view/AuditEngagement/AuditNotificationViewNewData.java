...
public class AuditNotificationViewNewData {
	...
	public void setData(AuditNotificationViewNew auditNotificationViewNew,
...
//		auditNotificationViewNew.getTxtBoxSubject().setText(selectedAuditEngagement.getSubject());
	...
	public void sendMessage(final Button btnSend) {
		...
		rpcService.saveAuditNotification(selectedAuditEngagement.getAuditEngId(), auditNotificationViewNew.getTxtAreaBody().getText(), auditNotificationViewNew.getTxtBoxForAction().getText(), auditNotificationViewNew.getTxtBoxForInfo().getText(), auditNotificationViewNew.getTxtBoxReference().getText(), auditNotificationViewNew.getTxtBoxFrom().getText(), auditNotificationViewNew.getTxtBoxSubject().getText(), new AsyncCallback<String>() {
