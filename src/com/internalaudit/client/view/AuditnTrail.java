...
public class AuditnTrail extends Composite {
	...
	private static AuditnTrailUiBinder uiBinder = GWT.create(AuditnTrailUiBinder.class);
		...
		columnSortHandler.setComparator(assignee, new Comparator<StrategicAudit>() {
			...
			public int compare(StrategicAudit o1, StrategicAudit o2) {
				...
				if (o1 != null) {
					...
					return (o2 != null)
							? o1.getAssignedTo().getEmployeeName().compareTo(o2.getAssignedTo().getEmployeeName()) : 1;
				}
				return -1;
			}
		});
		...
		columnSortHandler.setComparator(approvar, new Comparator<StrategicAudit>() {
			...
			public int compare(StrategicAudit o1, StrategicAudit o2) {
				...
				if (o1 != null) {
					...
					return (o2 != null)
							? o1.getApprovedBy().getEmployeeName().compareTo(o2.getApprovedBy().getEmployeeName()) : 1;
				}
				return -1;
			}
		});
