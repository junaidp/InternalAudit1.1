...
public class PortalIssue extends VerticalLayoutContainer {
	...
	public Widget createGridFieldWork() {
		...
		ColumnConfig<Issues, Integer> issueId = new ColumnConfig<Issues, Integer>(properties.id(), 30, "Id");
		ColumnConfig<Issues, String> issueTitle = new ColumnConfig<Issues, String>(properties.issueTitle(), 50,
				"Issue Title");
		...
		ColumnConfig<Issues, String> issueStatus = new ColumnConfig<Issues, String>(properties.status(), 50, "Status");
